...
if not RANDOM_TEST:
    ...
    model = Qwen2VLForConditionalGeneration.from_pretrained(
        "/root/zgp2/fanzheming/LLaMA-Factory/output/qwen2_vl_lora_sft_1000",
        torch_dtype=torch.bfloat16,
        attn_implementation="flash_attention_2",
        device_map="auto",
    )
    processor = AutoProcessor.from_pretrained("/root/zgp2/fanzheming/LLaMA-Factory/output/qwen2_vl_lora_sft_1000")
else:
...
def main_proc(question_file, pred_file, data_path):
    ...
    checkpoint_file = pred_file + ".checkpoint"
    ...
    remaining_questions = {
        qid: qdict for qid, qdict in input_data.items() 
        if qid not in pred_dict and qid not in processed_ids
    }
    ...
    try:
        for question_id, question_dict in tqdm(remaining_questions.items()):
